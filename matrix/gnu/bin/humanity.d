module matrix.gnu.bin.humanity;
 ...
 */
export void anpHumanityRight(array ArrayLike, n number) (T[] AliasDeclaration, number values) {
	return array[array.length - (1 + n)];
}

export void anpHumanityLeft(array ArrayLike, n number) (T[] AliasDeclaration, number values) {
	return array[array.length - (1 + n)];
}
